...
Revision ID: 0a21e4c23a3d
Revises: 
Create Date: 2025-02-05 12:31:40.661674
...
def upgrade():
    ...
    sa.Column('_user_home_directory_uc', sa.String(length=256), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('_user_home_directory_uc')
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('filepath', 'owner_id', name='uix_filepath_owner')
    )
